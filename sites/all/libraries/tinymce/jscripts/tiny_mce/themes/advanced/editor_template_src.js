	...
	tinymce.create('tinymce.themes.AdvancedTheme', {
		...
		init : function(ed, url) {
			...
			t.settings = s = extend({
				...
				theme_advanced_fonts : "Roboto-Black=Roboto-Black,Roboto-BlackItalic=Roboto-BlackItalic,Roboto-Bold=Roboto-Bold,Roboto-BoldItalic=Roboto-BoldItalic,Roboto-Italic=Roboto-Italic,Roboto-LightItalic=Roboto-LightItalic,Roboto-Medium=Roboto-Medium,Roboto-MediumItalic=Roboto-MediumItalic,Roboto-Regular=Roboto-Regular,Roboto-Thin=Roboto-Thin,Roboto-ThinItalic=Roboto-ThinItalic,Andale Mono=andale mono,monospace;Arial=arial,helvetica,sans-serif;Arial Black=arial black,sans-serif;Book Antiqua=book antiqua,palatino,serif;Comic Sans MS=comic sans ms,sans-serif;Courier New=courier new,courier,monospace;Georgia=georgia,palatino,serif;Helvetica=helvetica,arial,sans-serif;Impact=impact,sans-serif;Symbol=symbol;Tahoma=tahoma,arial,helvetica,sans-serif;Terminal=terminal,monaco,monospace;Times New Roman=times new roman,times,serif;Trebuchet MS=trebuchet ms,geneva,sans-serif;Verdana=verdana,geneva,sans-serif;Webdings=webdings;Wingdings=wingdings,zapf dingbats",
